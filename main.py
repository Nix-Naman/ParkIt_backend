...
previous_parking_status = [False] * len(parking_data)
...
# Check if the status has changed
            if status != parking_status[ind] and parking_buffer[ind] == None:
                ...
                parking_buffer[ind] = None
                 # Print the status only when it changes
            if parking_status[ind] != previous_parking_status[ind]:
                print(f"Parking spot {park['id']} is {'Free' if parking_status[ind] else 'Occupied'}")
                previous_parking_status[ind] = parking_status[ind]
                # print(previous_parking_status)
                dbi.addSpot(previous_parking_status)
